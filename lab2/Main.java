...
class FilmDirector extends Director {
    ...
    public int getNumberOfAwards() { return numberOfAwards; }
    public void setNumberOfAwards(int numberOfAwards) { this.numberOfAwards = numberOfAwards; }
...
class DocumentaryDirector extends Director {
    ...
    public int getNumberOfDocumentaries() { return numberOfDocumentaries; }
    public void setNumberOfDocumentaries(int numberOfDocumentaries) { this.numberOfDocumentaries = numberOfDocumentaries; }
    public String getSpecializationTopic() { return specializationTopic; }
    public void setSpecializationTopic(String specializationTopic) { this.specializationTopic = specializationTopic; }
...
class Screening {
    ...
    public void setScreeningName(String screeningName) { this.screeningName = screeningName; }
